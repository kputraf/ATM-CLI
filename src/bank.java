                                             ...
                                             "Pilih Transaksi",3);
                                              ...
                                              switch (choice)
                                              {
                                                  case 1 :
                                                        ...
                                                        z=JOptionPane.showConfirmDialog(null, "Melanjutkan transaksi lain?","ATM Mandiri-Surabaya",JOptionPane.YES_NO_OPTION,3); //konfirmasi transaksi lain
                                                            if (z==0)
                                                            break;
                                                            else
                                                                JOptionPane.showMessageDialog(null,"Terimakasih telah menggunakan ATM Mandiri-Surabaya, ambil kartu ATM  Anda.");
                                                                System.exit(0);
                                                  ...
                                                  case 3 : 
                                                      str1=JOptionPane.showInputDialog(null,"Masukkan jumlah penarikan: "); // penarikan
